    ...
    public class LoginViewModel : BindableObject
    {
        ...
        private async void OnLogin()
        {
            ...
            if (!string.IsNullOrEmpty(tokenResult))
            {
                ...
                {
                    Application.Current.MainPage = new NavigationPage(new PagesWearOS.WearOSMainPage());
                }
                else
                {
                    Application.Current.MainPage = new NavigationPage(new Pages.CustomMainPage());
                }
            }
            else
            {
