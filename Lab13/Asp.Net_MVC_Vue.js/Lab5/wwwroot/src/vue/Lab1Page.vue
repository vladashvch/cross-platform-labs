            ...
            <section class="solution-section">
                <div>
                    ...
                    <form @submit="submitForm">
                        ...
                        <input type="number" v-model="nValue" id="nValue" name="nValue" min="1" max="20" required>

                        <label for="aValue">A - Кількість червоних куль:</label>
                        <input type="number" v-model="aValue" id="aValue" name="aValue" min="0" max="20" required>

                        <label for="bValue">B - Кількість зелених куль:</label>
                        <input type="number" v-model="bValue" id="bValue" name="bValue" min="0" max="20" required>
